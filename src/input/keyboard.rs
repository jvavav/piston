...
bitflags! {
    ...
    pub struct ModifierKey: u8 {
        ...
        /// Ctrl + Shift.
        const CTRL_SHIFT            = Self::CTRL.bits()
                                    | Self::SHIFT.bits();
        /// Ctrl + Alt.
        const CTRL_ALT              = Self::CTRL.bits()
                                    | Self::ALT.bits();
        /// Ctrl + Gui.
        const CTRL_GUI              = Self::CTRL.bits()
                                    | Self::GUI.bits();
        /// Ctrl + Shift + Alt.
        const CTRL_SHIFT_ALT        = Self::CTRL.bits()
                                    | Self::SHIFT.bits()
                                    | Self::ALT.bits();
        /// Ctrl + Shift + Gui.
        const CTRL_SHIFT_GUI        = Self::CTRL.bits()
                                    | Self::SHIFT.bits()
                                    | Self::GUI.bits();
        /// Ctrl + Shift + Alt + Gui.
        const CTRL_SHIFT_ALT_GUI    = Self::CTRL.bits()
                                    | Self::SHIFT.bits()
                                    | Self::ALT.bits()
                                    | Self::GUI.bits();
        /// Shift + Alt.
        const SHIFT_ALT             = Self::SHIFT.bits()
                                    | Self::ALT.bits();
        /// Shift + Gui.
        const SHIFT_GUI             = Self::SHIFT.bits()
                                    | Self::GUI.bits();
        /// Shift + Alt + Gui.
        const SHIFT_ALT_GUI         = Self::SHIFT.bits()
                                    | Self::ALT.bits()
                                    | Self::GUI.bits();
        /// Alt + Gui.
        const ALT_GUI               = Self::ALT.bits()
                                    | Self::GUI.bits();
    }
}
